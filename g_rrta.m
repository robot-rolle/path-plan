function     [RRTree_main,static_param_data,donytic_param_data]=g_rrta(RRTree_main,GraftTree,RRTree_goal,static_param_data,donytic_param_data,map),
	...
	[A, I]=min( distanceCost(RRTree_main(:,1:2),sample) ,[],1); % find closest as per the function in the metric node to the sample
	...
	RRTree_main = [RRTree_main;newPoint I(1) ];
